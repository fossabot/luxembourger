    ...
    render() {
        ...
        return (
            <div className={"theme"}>
                ...
                <a className="be_theme-balloon"  target='_blank' rel={rel}
                   href='http://www.balloon.lu/' title='Click to open Aerostatique Association website'> </a>

                <a className="be_theme-sun" target='_blank' rel={rel}
                   href='https://www.meteolux.lu/' title='Click to open MeteoLux website'> </a>

                <a className="be_theme-cloud-big" target='_blank' rel={rel}
                   href='https://www.meteolux.lu/' title='Click to open MeteoLux website'> </a>

                <a className="be_theme-cloud-big-2" target='_blank' rel={rel}
                   href='https://www.meteolux.lu/' title='Click to open MeteoLux website'> </a>

                <a className="be_theme-cloud-medium" target='_blank' rel={rel}
                   href='https://www.meteolux.lu/' title='Click to open MeteoLux website'> </a>

                <a className="be_theme-cloud-small" target='_blank' rel={rel}
                   href='https://www.meteolux.lu/' title='Click to open MeteoLux website'> </a>

                <a className="be_plane" target='_blank' rel={rel}
                   href='https://www.luxair.lu/fr' title='Click to open LuxAir website'> </a>

                <a className="be_univers" target='_blank' rel={rel}
