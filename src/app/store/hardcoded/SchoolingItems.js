...
export const schoolingItems: CategoryItem[] = [
    new CategoryItem('Public Schools',
        ...
        '/images/schooling/public-schools.png',
    ...
    //     '/wiki/schooling/test2.md'),
    //
    // new CategoryItem('Weekend "Nations" schools',
